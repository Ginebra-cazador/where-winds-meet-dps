...
export const mobladeheavycharge1bwPerception = defineSkill({
  id: SKILL.mobladeheavycharge1bwPerception,
  classId: "stonesplitMight",
  name: "MoBladeHeavyCharge-1BW[Perception]",
  tags: [
    PROP.isCharged,
    PROP.abrasionImmune,
    WEAPON.moBlade,
  ...
  castTag: "cast:moBladeHeavyCharge1BWPerception",
  castFrames: 105,
  triggerable: true,
