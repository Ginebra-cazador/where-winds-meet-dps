...
export function GearDetailsPanel({
  ...
  return (
    <div className="panel gear-details">
      <div className="cr-toolbar">
        <span className="cr-toolbar-label">{t("Gear details")}</span>
        <div className="cr-spacer" />
        {readOnly ? (
          <button type="button" className="cr-btn primary" onClick={onEquip}>
            {t("Equip")}
          </button>
        ) : (
          <>
            {isEquipped ? (
              <button type="button" className="cr-btn" onClick={onUnequip}>
                {t("Unequip")}
              </button>
            ) : (
              <button type="button" className="cr-btn primary" onClick={onEquip}>
            ...
            <button type="button" className="cr-btn danger" onClick={onDelete}>
              {t("Delete")}
            </button>
          </>
        )}
