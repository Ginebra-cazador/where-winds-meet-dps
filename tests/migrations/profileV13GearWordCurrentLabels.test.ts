...
describe("V13 is registered and the chain reaches it", () => {
  it("is registered in the chain", () => {
    expect(PROFILE_MIGRATIONS).toContain(V13__gearWordCurrentLabels)
    expect(LATEST_PROFILES_VERSION).toBeGreaterThanOrEqual(13)
  })

  it("a v12 blob walks through this step to the latest version and stores ids", () => {
